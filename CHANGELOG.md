...
All Notable changes to `laravel-power` will be documented in this file.
...
Now Power returns appropriate exit codes
...
- Replaced `make:powers` command by publishing `powers` tag
- Updated default power stubs
...
- conflict for Laravel 5.5 and `symfony/process:~4.0`, Laravel 5.5 uses `~3.0` version. Laravel Power now support `symfony/process:~3.0|~4.0`
